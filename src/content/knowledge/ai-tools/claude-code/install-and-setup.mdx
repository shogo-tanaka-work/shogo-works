...
この記事は**認証方式とパーミッション設計まで含めた実務向けの集約版**です。
はじめての導入で、画面の操作から一歩ずつ確認したい場合は入門コースを参照してください。

- [2-0 CLI とデスクトップアプリ、どちらで始めるか](/knowledge/ai-tools/claude-code-curriculum/02-0-choose-your-environment)
- [2-1 Windows にインストールする手順](/knowledge/ai-tools/claude-code-curriculum/02-1-install-windows) / [2-2 Mac にインストールする手順](/knowledge/ai-tools/claude-code-curriculum/02-2-install-mac)
- [2-3 初回起動チェックリスト](/knowledge/ai-tools/claude-code-curriculum/02-3-first-launch-checklist)

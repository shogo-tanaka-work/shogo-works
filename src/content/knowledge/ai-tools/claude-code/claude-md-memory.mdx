...
- 非エンジニア向けの入門: [5-1 CLAUDE.md の書き方](/knowledge/ai-tools/claude-code-curriculum/05-1-claude-md)
- チームで共有する設計: [AGENTS.md 設計](/knowledge/harness-engineering/agents-md-design)
- Codex 側の AGENTS.md: [Codex の AGENTS.md](/knowledge/ai-tools/codex/agents-md)

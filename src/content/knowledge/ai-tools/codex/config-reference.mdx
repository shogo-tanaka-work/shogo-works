...
- [Configuration advanced — Codex Docs](https://learn.chatgpt.com/docs/config-file/config-advanced)
- [Sample configuration — Codex Docs](https://learn.chatgpt.com/docs/config-file/config-sample)

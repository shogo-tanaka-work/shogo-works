...
公式ドキュメントは [`learn.chatgpt.com/docs/config-file/config-advanced`](https://learn.chatgpt.com/docs/config-file/config-advanced)。
...
- [Codex Advanced Config（公式）](https://learn.chatgpt.com/docs/config-file/config-advanced)

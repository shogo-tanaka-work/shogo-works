...
公式ドキュメントは [`learn.chatgpt.com/docs/agent-configuration/rules`](https://learn.chatgpt.com/docs/agent-configuration/rules)。
...
- [Codex Rules（公式）](https://learn.chatgpt.com/docs/agent-configuration/rules)

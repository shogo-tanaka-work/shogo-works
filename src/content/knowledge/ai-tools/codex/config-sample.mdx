...
- 公式 [Sample Config](https://learn.chatgpt.com/docs/config-file/config-sample) は **コピペで使える実用テンプレート**
...
- [Codex Sample Config（公式）](https://learn.chatgpt.com/docs/config-file/config-sample)

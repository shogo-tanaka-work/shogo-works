...
- [ChatGPT desktop app — Codex Docs](https://learn.chatgpt.com/docs/app)
- [Computer Use — Codex Docs](https://learn.chatgpt.com/docs/computer-use)
- [Automations — Codex Docs](https://learn.chatgpt.com/docs/automations?surface=app)
- [Cloud / Web — Codex Docs](https://learn.chatgpt.com/docs/cloud)

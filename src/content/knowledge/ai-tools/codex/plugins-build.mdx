...
公式ドキュメントは [`developers.openai.com/codex/plugins/build`](https://developers.openai.com/codex/plugins/build)（このページのみ旧ドメインに残存）。プラグイン全般は [`learn.chatgpt.com/docs/plugins`](https://learn.chatgpt.com/docs/plugins)。
...
- [Package your plugin（公式）](https://developers.openai.com/codex/plugins/build)
- [Plugins（公式）](https://learn.chatgpt.com/docs/plugins)

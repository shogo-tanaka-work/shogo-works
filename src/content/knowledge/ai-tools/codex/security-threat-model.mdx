...
[Codex Security](https://learn.chatgpt.com/docs/security) は、接続済みの GitHub リポジトリを対象に脆弱性候補を探し、優先度付きの finding と修正案を提示する機能です。
...
公式ドキュメントは [`learn.chatgpt.com/docs/security`](https://learn.chatgpt.com/docs/security) と [`learn.chatgpt.com/docs/security/threat-model`](https://learn.chatgpt.com/docs/security/threat-model)。
...
- [Codex Security（公式）](https://learn.chatgpt.com/docs/security)
- [Codex Threat Model（公式）](https://learn.chatgpt.com/docs/security/threat-model)
- [Codex Security Setup（公式）](https://learn.chatgpt.com/docs/security/setup)
- [Codex Security FAQ（公式）](https://learn.chatgpt.com/docs/security/faq)

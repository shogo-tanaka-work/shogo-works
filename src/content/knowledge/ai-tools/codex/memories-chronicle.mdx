...
公式ドキュメントは [`learn.chatgpt.com/docs/customization/memories`](https://learn.chatgpt.com/docs/customization/memories?surface=app) と [`learn.chatgpt.com/docs/customization/computer-history`](https://learn.chatgpt.com/docs/customization/computer-history)。
...
- [Codex Memories（公式）](https://learn.chatgpt.com/docs/customization/memories?surface=app)
- [Codex Memories / Chronicle（公式）](https://learn.chatgpt.com/docs/customization/computer-history)

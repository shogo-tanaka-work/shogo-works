...
- [CLI Reference — Codex Docs](https://learn.chatgpt.com/docs/developer-commands?surface=cli)
- [Slash Commands — Codex Docs](https://learn.chatgpt.com/docs/developer-commands?surface=cli)

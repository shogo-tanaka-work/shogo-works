...
公式ドキュメントは [`learn.chatgpt.com/docs/agent-configuration/speed`](https://learn.chatgpt.com/docs/agent-configuration/speed)。
...
- [Codex Speed（公式）](https://learn.chatgpt.com/docs/agent-configuration/speed)

...
2026-04-02 から **クレジット定額の利用枠 + API トークン課金** のハイブリッドへ移行しました。最新情報は [Codex Pricing](https://learn.chatgpt.com/docs/pricing) と [Codex Rate Card（Help Center）](https://help.openai.com/en/articles/20001106-codex-rate-card) を参照してください。
...
> GPT-5.3-Codex / 5.3-Codex-Spark / 5.4-mini の単価は公式 Pricing ページ（[/codex/pricing](https://learn.chatgpt.com/docs/pricing)）で確認してください。
...
- [Codex ドキュメント（トップ）](https://learn.chatgpt.com/docs)
- [Codex Models](https://learn.chatgpt.com/docs/models)
- [Codex Pricing](https://learn.chatgpt.com/docs/pricing) / [Rate Card](https://help.openai.com/en/articles/20001106-codex-rate-card)

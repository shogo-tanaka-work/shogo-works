...
- **Sandbox**：エージェントが任意コードを安全に実行するための隔離環境。詳細は [MCP と Sandbox](/knowledge/web-development/vercel/42-mcp-and-sandbox) を参照
- **Vercel Agent**：PR レビュー / 異常検知の運用エージェント。Pro 以上で全 PR 対象。詳細は [AI Agents と Claim Deployments](/knowledge/web-development/vercel/43-ai-agents-and-claim-deployments) を参照

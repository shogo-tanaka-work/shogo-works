...
> **Queues は 2026-08-28 時点で public beta です。**2026-02-27 に limited beta から public beta へ移りましたが、GA のアナウンスは確認できていません。本番採用の判断材料にする場合はこの点を織り込んでください。
>
> 主な上限は、TTL 最大 7 日（既定 24 時間）、visibility timeout 最大 60 分（既定 60 秒）、メッセージ最大 100 MB、課金は 4 KiB 単位。単価は $0.60 / 100 万 operations から（リージョン別）。Python SDK も 2026-08-19 から beta で提供されています。
>
> 出典: [Vercel Queues now in public beta](https://vercel.com/changelog/vercel-queues-now-in-public-beta) / [Queues Pricing and Limits](https://vercel.com/docs/queues/pricing)

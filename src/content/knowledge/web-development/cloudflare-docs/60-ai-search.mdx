...
tags: ["Cloudflare", "AI Search", "ドキュメント要約"]
...
## 料金プレビューが公開された（2026-08-06）

ベータ中は無料ですが、**課金開始後の単価が先に公表**されています。

| 項目 | 単価 |
|---|---|
| Ingest | $0.75 / 100万トークン |
| Storage | $2.00 / GB・月 |
| Semantic query | $0.75 / 1,000クエリ |
| Full-text query | $0.10 / 1,000クエリ |
| Embedding / rerank | 一部の Workers AI モデルでは無料 |

課金開始前にメール通知がある、と公式に明記されています。**採用を検討するなら、この単価で見積もっておくと後から慌てません。**

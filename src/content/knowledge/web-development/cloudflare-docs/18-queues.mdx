---
title: "Cloudflare Queues：Workersで使う非同期処理・バッチ基盤の構築"
...
tags: ["Cloudflare", "Queues", "ドキュメント要約"]
...
| 時期 | 変更 |
|---|---|
| 2026-02-04 | **Workers Free プランで利用可能に**（最大10,000キュー、1日10,000操作） |
| 2026-04-28 | リアルタイムの backlog メトリクス |
| 2026-07-15 | **Email Sending のイベント購読**（配信・バウンス・苦情） |
| 2026-08 | Artifacts / Workers Builds のイベント購読 |

**Free プランで使えるようになった**のが大きい変更です。以前は Queues を使うだけで Workers Paid が必要でした。

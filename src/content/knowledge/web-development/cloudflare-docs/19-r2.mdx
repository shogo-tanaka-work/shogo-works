---
title: "Cloudflare R2：エグレス無料のS3互換ストレージで配信コストを削減"
...
| 時期 | 変更 |
|---|---|
| 2026-08-17 | **`us` jurisdiction** — 保存と処理を米国内に限定できる |
| 2026-07-24 | Sippy が **Azure Blob と任意の S3 互換**に対応（移行元の選択肢が広がった） |
| 2026-08-03 | **R2 Data Catalog が非 Enterprise アカウントで課金開始**（→ [R2 Data Catalog](./r2-data-catalog)） |

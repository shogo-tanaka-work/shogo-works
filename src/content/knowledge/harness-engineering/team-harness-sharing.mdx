---
title: "チームでのハーネス共有と標準化：出力品質のばらつきをなくすGit管理術"
...
CLAUDE.mdやAGENTS.mdはプロジェクトの「目次」として機能させます。OpenAIの事例ではAGENTS.mdを詳細文書への入口として使っていますが、100行という値を共通ルールにはしません。詳細は正本となる設計・仕様・運用文書へ配置します。

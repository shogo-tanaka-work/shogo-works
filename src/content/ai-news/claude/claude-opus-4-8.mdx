---
title: "Claude Opus 4.8 リリース — Terminal-Bench 2.1 首位、Fast mode 3倍安価・2.5倍速、料金は4.7同等、API は `claude-opus-4-8`、Claude Code dynamic workflows / Effort Control / Messages API システムエントリ拡張も同時"
tool: "claude"
toolLabel: "Claude"
date: 2026-05-28

---
title: "Project Glasswing中間報告：OSS脆弱性1万件超をClaudeが検出"
tool: "claude"
toolLabel: "Claude"
date: 2026-05-22
...
description: "AnthropicがClaude Mythos Previewを使った防御的セキュリティ研究「Project Glasswing」の中間報告を公開。OSS 1,000件超で高・重大度脆弱性を1万件超検出したことで、Claudeを脆弱性検出パイプラインに組み込む議論が現実的になる。"

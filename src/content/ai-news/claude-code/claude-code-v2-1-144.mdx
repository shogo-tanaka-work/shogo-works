---
title: "Claude Code v2.1.144：background session再開・起動ハング解消・MCP修正"
tool: "claude-code"
...
description: "/resumeがbackground sessionにも対応し、複数agentの継続運用がしやすくなった。起動時の75秒ハング解消やMCPのツール取りこぼし修正など、チーム運用基盤としての安定性が向上したリリースノートを解説。"

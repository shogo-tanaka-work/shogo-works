---
title: "Claude Code v2.1.152：レビュー自動適用・MessageDisplay hook・skill再スキャン"
tool: "claude-code"
...
description: "`/code-review --fix` でレビュー結果を作業ツリーへ即反映、`MessageDisplay` hookで出力制御、`/reload-skills` でセッション維持のままskillを再スキャンできるようになった変更点を解説。"

---
title: "Claude Code v2.1.166：fallbackModel・denyルールglob・セキュリティ強化"
tool: "claude-code"
toolLabel: "Claude Code"
date: 2026-06-06
sourceUrl: "https://github.com/anthropics/claude-code/releases/tag/v2.1.166"
description: "モデル過負荷時に最大3つの代替モデルへ自動切替できるfallbackModel設定、denyルールでのglobパターン対応によるデフォルト拒否設計、クロスセッション権限昇格を防ぐセキュリティ修正の詳細をまとめています。"

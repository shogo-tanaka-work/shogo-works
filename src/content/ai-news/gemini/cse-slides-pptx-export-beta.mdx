---
title: "Google Workspace、CSE Slides を Vault / Takeout エクスポート後に PowerPoint へ変換可能（ベータ）— Enterprise Plus / Education Standard・Plus / Frontline Plus / Assured Controls 系対象、CSE Office Interop beta 登録が前提"
tool: "gemini"

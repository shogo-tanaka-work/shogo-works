---
title: "Workspace Studio：ループ処理追加・Geminiリスト出力対応"
tool: "gemini"
...
description: "Google Workspace StudioにRepeat for eachステップが追加。スプレッドシート行やリストを1件ずつ反復処理でき、Geminiのリスト出力をそのままループ入力に渡せる。営業リードへのメール下書きや議事録のタスク化をノーコードで自動化したいエンジニア・業務担当者向け。"

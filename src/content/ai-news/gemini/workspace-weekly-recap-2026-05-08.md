---
title: "Google Workspace 5/8週：AI制御センター・Docs持続指示・Meet同意設定"
tool: "gemini"
...
description: "Google Workspaceの2026年5月8日週次アップデートで、管理コンソールにAI制御センターが追加され生成AIのポリシー管理が一元化。Docs GeminiにChatGPT風の持続カスタム指示が実装され、Meet録画時の参加者同意設定も可能になった変更点をまとめて解説。"

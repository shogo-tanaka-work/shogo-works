---
title: "Gemini の「Organize My Files in Drive」が GA — 散在ファイルの移動先（既存フォルダ / 新規フォルダ作成）を提案し、レビュー後に一括移動。Business / Enterprise・Google AI Pro/Ultra・Education 対象、英語でグローバル、7/15 まで上限引き上げのプロモ枠"
tool: "gemini"

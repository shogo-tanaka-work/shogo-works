---
title: "Codex rust-v0.134.0：会話履歴検索・profile昇格・MCP強化"
tool: "codex"
...
description: "Codex CLI rust-v0.134.0では、過去の会話履歴をキーワード検索できるthread content search追加、--profileが主セレクタに昇格しlegacy v1が廃止、MCP per-server環境変数とOAuth対応、readOnlyHint申告ツールの並列実行が可能になりました。"

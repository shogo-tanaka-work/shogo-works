---
title: "OpenAI Codex rust-v0.135.0、`codex doctor` 環境診断・`/status` リモート接続・Vim mode 拡張・`/permissions` 名前付きプロファイル・bundled patched zsh・Python SDK Sandbox preset・memory state 専用 SQLite"
tool: "codex"

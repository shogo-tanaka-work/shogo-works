---
title: "OpenAI Codex：役割特化プラグイン・アノテーション・Sites発表"
tool: "codex"
...
description: "OpenAI CodexがSnowflake・Figma・Canvaなど62アプリ対応の役割特化プラグイン（110スキル）を追加。コーディング不要でデータ分析・クリエイティブ制作に使えるほか、URLで共有できる軽量アプリを生成するCodex Sitesも登場。"

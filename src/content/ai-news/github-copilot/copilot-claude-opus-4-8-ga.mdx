---
title: "GitHub Copilot で Claude Opus 4.8 が GA、Pro+/Business/Enterprise 対応 — 2026-06-01 まで 15x premium 乗数、Business/Enterprise は管理ポリシー有効化必要、VS Code / Visual Studio / Copilot CLI で利用可"
tool: "github-copilot"

---
title: "GitHub Copilot が全プランで GitHub AI Credits ベースの従量課金へ移行 — PRU 廃止、Copilot code review が Actions 分も消費、ユーザー単位予算が GA。プラン価格（Pro $10 / Pro+ $39 / Business $19 / Enterprise $39）は据え置き、コード補完は AI Credits 非消費"
tool: "github-copilot"

---
title: "GitHub Copilot：コンテキスト拡大・推論レベル設定・Agent tasks API開放"
tool: "github-copilot"
...
description: "GitHub Copilotがコンテキストウィンドウ拡大と推論レベル設定に対応し、精度とコストのトレードオフを開発者が調整できるように。Agent tasks REST APIがPro/Pro+/Maxでも利用可能になり、CI自動修正などのスクリプト自動化が個人・小規模チームでも組みやすくなった変更点を解説。"

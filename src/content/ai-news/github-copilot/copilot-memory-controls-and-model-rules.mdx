---
title: "GitHub Copilot：Memory制御強化・CLIと組織別Model rules"
tool: "github-copilot"
...
description: "Copilot Memoryに/memory CLIとリポジトリ単位OFFスイッチが追加。scopeの種類も明示され、OSS・法務NGリポジトリでの安全運用が可能に。Model rulesでEnterpriseオーナーが組織ごとに使えるモデルを制御できるようになり、階層ガバナンス設計を一段整理できる。"

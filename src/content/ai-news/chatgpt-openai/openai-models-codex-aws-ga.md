---
title: "GPT-5.5/Codex on AWS：Bedrock GA・追加マージンなし・IDE連携対応"
tool: "chatgpt-openai"
...
description: "GPT-5.5・GPT-5.4・CodexがAmazon Bedrockで正式GA。既存のIAM/VPC/KMS/CloudTrailをそのまま使い、OpenAI直販と同額・追加マージンなしでフロンティアモデルを本番投入できる。AWS環境でOpenAIを使いたい企業・エンジニアの導入障壁を下げる変更点を解説。"

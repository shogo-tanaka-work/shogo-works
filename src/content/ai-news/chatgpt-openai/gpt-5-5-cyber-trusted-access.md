---
title: "GPT-5.5-Cyber：サイバー業務向け限定プレビュー開始"
tool: "chatgpt-openai"
...
description: "OpenAIがレッドチーム・ペネトレーションテスト・脆弱性検証など公開モデルでは断られるワークフローを扱えるGPT-5.5-Cyberを限定公開。Trusted Access for Cyberの最高ティア承認組織のみアクセス可能で、SOC・CSIRTチームがLLM活用範囲を設計し直すきっかけとなる。"
